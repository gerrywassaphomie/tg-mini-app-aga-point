...
// Обновление списка репортов (новые сверху)
...
// Кнопка Report (через Telegram геолокацию)
document.getElementById('reportBtn').addEventListener('click', ()=>{
  Telegram.WebApp.getLocation({}).then(loc=>{
...
// Toggle списка
listBtn.onclick=()=>{ reportList.style.display = (reportList.style.display==='none'||reportList.style.display==='')?'block':'none'; }
